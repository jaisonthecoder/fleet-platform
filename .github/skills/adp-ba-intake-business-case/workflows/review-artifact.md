...
- Confirm the artifact under review plus the source business case, funding, approval, and benefit evidence.
...
2. Check whether investment rationale, funding path, approval forum, benefit measures, and source evidence are complete.
3. Produce findings with severity, evidence, required follow-up, and downstream impact.
4. Identify unsupported investment claims, missing owners, weak benefit measures, and unclear decision gates.
5. State whether the artifact is ready for BRD or PRD handoff.
...
## Anti-patterns
- Approving an artifact whose benefits cannot be measured.
- Treating missing funding approval as a minor wording issue.
- Reviewing only format while ignoring source evidence.
