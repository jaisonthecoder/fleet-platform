---
name: adp-review-record
description: "Formal review evidence: scope, findings, responses, exceptions, unresolved issues, final decision. Use when producing or updating \\\"review-record.md or remote PR/review record\\\". Owned by AI Reviewer."
---
...
- **why_critical:** Provides audit trail and review evidence beyond what individual comments capture, supporting compliance, impact analysis, and release decisions.
- **default_prompt:** Use the adp-review-record skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Formal review evidence guidance

**Owner role:** AI Reviewer (`ai-reviewer`)
**Primary artifact:** review-record.md or remote PR/review record

## Why critical
Provides audit trail and review evidence beyond what individual comments capture, supporting compliance, impact analysis, and release decisions.

## Purpose
Formal review evidence: scope, findings, responses, exceptions, unresolved issues, final decision.
...
- **Protects:** merge readiness.
- **Optimizes for:** risk-first findings with precise remediation.
- **Refuses to leave ambiguous:** behavior, test, security, or evidence ambiguity.
- **Primary artifact focus:** review-record.md or remote PR/review record.
...
- **When using adp-review-record:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing review-record.md or remote PR/review record:** confirm the artifact is owned by this skill and not a neighboring role.
- **Before changing scope:** confirm the change still protects merge readiness and does not dilute risk-first findings with precise remediation.
...
- A reviewer should be able to see how this skill handled behavior, test, security, or evidence ambiguity.
...
- A new instance of `review-record.md or remote PR/review record` is required.
...
## Outputs
- review-record.md or remote PR/review record
...
- `workflows/arbitrate-technical-decision.md`
- `workflows/assess-change-risk.md`
- `workflows/coach-engineer.md`
- `workflows/technical-readiness-review.md`
...
- `references/merged-from-tech-lead.md` — legacy `tech-lead` guidance merged into this ADP task skill.
...
- **SDLC stage:** Review
- **Ordered by:** `ai-backend-dotnet`, `ai-backend-nestjs`, `ai-backend-python`, `ai-frontend-react`, `ai-frontend-angular`, `ai-mobile-rn`, `ai-mobile-ios`, `ai-mobile-android`, `ai-mobile-flutter`, `ai-integration-engineer`, `ai-data-engineer`, `ai-database-engineer`, `ai-ml-engineer`, `ai-quality-engineer`, `ai-security-engineer`
- **Required inputs:** `PR/diff`, `test evidence`, `linked artifact`, `risk summary`
- **Generated artifact:** `review-record.md or remote PR/review record`
- **Next roles:** `ai-delivery-planner`, `ai-platform-engineer`, `ai-sre`
- **Human gate:** `merge approval`, `risk acceptance`

## Handoff

- **Upstream:** Confirm the request, source evidence, and approved upstream artifacts before acting.
- **Downstream:** `ai-delivery-planner`, `ai-quality-engineer`.
