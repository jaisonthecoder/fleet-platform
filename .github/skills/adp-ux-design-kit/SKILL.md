---
name: adp-ux-design-kit
description: "Design system foundations: color, typography, spacing, radius, elevation, motion, components, states, accessibility rules, shadcn React and Angular mapping. Use when producing or updating \\\"design-system-kit.md\\\" or design tokens. Owned by AI UX/UI Designer."
---
...
- **why_critical:** Stops AI and frontend workers inventing UI rules and keeps screens/components visually and behaviorally consistent.
- **default_prompt:** Use the adp-ux-design-kit skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Design tokens, components, states, framework mapping

**Owner role:** AI UX/UI Designer (`ai-ux-ui-designer`)
**Primary artifact:** design-system-kit.md

## Why critical
Stops AI and frontend workers inventing UI rules and keeps screens/components visually and behaviorally consistent.

## Purpose
Design system foundations: color, typography, spacing, radius, elevation, motion, components, states, accessibility rules, shadcn React and Angular mapping, and implementation-ready UX handoff notes.
...
- **Primary artifact focus:** design-system-kit.md.
...
8. **Ship design-system substance, not governance alone.** Design-kit outputs must define foundations, color tokens, typography tokens, component inventory, variants, states, accessibility rules, framework mappings, validation evidence, and handoff expectations so downstream teams do not invent missing UI rules.
...
- **When using adp-ux-design-kit:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing design-system-kit.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `design-system-kit.md` is required.
- Color tokens, typography tokens, or framework token mappings are required.
...
- Design token contract for color, typography, spacing, radius, elevation, and motion.
...
- `workflows/produce-artifact.md` — create a new `design-system-kit.md`.
- `workflows/update-artifact.md` — update an existing `design-system-kit.md`.
- `workflows/review-artifact.md` — review an existing `design-system-kit.md` or design-kit proposal.
- `workflows/design-components.md` — define or extend reusable design-system components.
- `workflows/design-accessibility.md` — validate accessibility rules, states, and exceptions.

If the request involves implementation guidance for a specific UI stack, load exactly one matching reference set after the workflow:

- shadcn / React / Tailwind: `references/shadcn-tokens-spec.md`, `references/shadcn-sections-catalog.md`, and `references/tailwind-mapping.md`.
- ng-bootstrap / Angular / Bootstrap: `references/ng-bootstrap-tokens-spec.md`, `references/ng-bootstrap-sections-catalog.md`, and `references/bootstrap-mapping.md`.

## References

Load only the references needed for the current request:
- `references/bootstrap-mapping.md` — maps design tokens to Bootstrap SCSS variables, utilities, and component classes.
- `references/ng-bootstrap-sections-catalog.md` — Angular/ng-bootstrap UI kit sections and component coverage.
- `references/ng-bootstrap-tokens-spec.md` — Angular/ng-bootstrap token contract and validation checklist.
- `references/shadcn-sections-catalog.md` — React/shadcn UI kit sections and component coverage.
- `references/shadcn-tokens-spec.md` — React/shadcn token contract and validation checklist.
- `references/tailwind-mapping.md` — maps design tokens to Tailwind theme keys, utilities, and component usage rules.
...
- **Required inputs:** `prd.md`, `personas`, `user journey`, `accessibility constraints`
- **Generated artifact:** `design-system-kit.md`
