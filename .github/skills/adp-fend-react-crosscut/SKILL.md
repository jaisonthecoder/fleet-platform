---
name: adp-fend-react-crosscut
description: "Auth, tracing, logging, correlation IDs, error boundary, config, secrets access, feature flags, API client wiring. Use when producing or updating \\\"frontend React source code\\\". Owned by AI Frontend Engineer (React)."
---

# adp-fend-react-crosscut
...
- **why_critical:** Keeps enterprise technical behavior consistent instead of repeating it differently across frontend pages and features.
- **default_prompt:** Use the adp-fend-react-crosscut skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Auth, tracing, logging, correlation IDs, error boundary, config

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** frontend React source code

## Why critical
Keeps enterprise technical behavior consistent instead of repeating it differently across frontend pages and features.

## Purpose
Auth, tracing, logging, correlation IDs, error boundary, config, secrets access, feature flags, API client wiring.
...
- **When using adp-fend-react-crosscut:** finish with the files changed and the evidence a reviewer should inspect first.
