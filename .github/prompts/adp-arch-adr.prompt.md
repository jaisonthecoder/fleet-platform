...
Use the `adp-arch-adr` skill at `.github/skills/adp-arch-adr/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-arch-adr/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
