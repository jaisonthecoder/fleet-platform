...
Use the `adp-bknd-nest-module-patterns` skill at `.github/skills/adp-bknd-nest-module-patterns/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-module-patterns/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
