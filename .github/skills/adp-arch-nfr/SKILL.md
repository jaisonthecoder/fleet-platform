---
name: adp-arch-nfr
description: "Measurable quality targets and validation methods. Use when producing or updating \\\"nfr.md\\\". Owned by AI Solution Architect."
---
...
- **why_critical:** Prevents functionally correct but production-weak solutions.
- **default_prompt:** Use the adp-arch-nfr skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Measurable quality targets and validation methods

**Owner role:** AI Solution Architect (`ai-solution-architect`)
**Primary artifact:** nfr.md

## Why critical
Prevents functionally correct but production-weak solutions.

## Purpose
Measurable quality targets and validation methods.
...
8. **Ask before generating.** Before producing the NFR document, ask blocking open questions about quality categories, targets, thresholds, workloads, measurement methods, evidence, and ownership; unanswered blockers must be recorded as assumptions, risks, or deferred open questions.
...
- **When using adp-arch-nfr:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing nfr.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `nfr.md` is required.
...
- `templates/nfr-template.md.tmpl` — Non-Functional Requirements.
...
- **Required inputs:** `brd.md`, `prd.md or product scope`, `business constraints`, `domain context`
- **Generated artifact:** `nfr.md`
...
- **Human gate:** `product definition approval`, `quality target approval`, `integration or data-risk approval`
