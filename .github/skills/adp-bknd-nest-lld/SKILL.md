---
name: adp-bknd-nest-lld
description: "Backend technical design: module boundaries, sequence, OpenAPI, class-validator DTOs, errors, implementation notes. Use when producing or updating \\\"lld.md, lld-api-spec.md, lld-data-spec-data-model.md\\\". Owned by AI Backend Engineer (NestJS)."
---
...
- **default_prompt:** Use the adp-bknd-nest-lld skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Backend technical design guidance

**Owner role:** AI Backend Engineer (NestJS) (`ai-backend-nestjs`)
**Primary artifact:** lld.md, lld-api-spec.md, lld-data-spec-data-model.md

## Why critical
Prevents backend implementation from inventing design details after architecture approval.

## Purpose
Backend technical design: module boundaries, sequence, OpenAPI, class-validator DTOs, errors, implementation notes.
...
- **Primary artifact focus:** lld.md, lld-api-spec.md, lld-data-spec-data-model.md.
...
- **When using adp-bknd-nest-lld:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing lld.md, lld-api-spec.md, lld-data-spec-data-model.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `lld.md, lld-api-spec.md, lld-data-spec-data-model.md` is required.
...
- **Generated artifact:** `lld.md`, `lld-api-spec.md`, `lld-data-spec-data-model.md`
