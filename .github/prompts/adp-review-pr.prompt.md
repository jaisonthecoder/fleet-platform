...
Use the `adp-review-pr` skill at `.github/skills/adp-review-pr/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-review-pr/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
