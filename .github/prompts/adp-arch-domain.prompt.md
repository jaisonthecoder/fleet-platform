...
Use the `adp-arch-domain` skill at `.github/skills/adp-arch-domain/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-arch-domain/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
