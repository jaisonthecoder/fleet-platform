...
Use the `adp-ux-research` skill at `.github/skills/adp-ux-research/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ux-research/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
