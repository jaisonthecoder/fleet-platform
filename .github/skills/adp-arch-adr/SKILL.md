---
name: adp-arch-adr
description: "Options, decision, rationale, consequences, revisit condition. Use when producing or updating \\\"docs/03-architecture/ADR/adr-NNNN-*.md\\\". Owned by AI Solution Architect."
---
...
- **why_critical:** Keeps decisions out of HLD and preserves rationale.
- **default_prompt:** Use the adp-arch-adr skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Options, decision, rationale, consequences, revisit condition

**Owner role:** AI Solution Architect (`ai-solution-architect`)
**Primary artifact:** docs/03-architecture/ADR/adr-NNNN-*.md

## Why critical
Keeps decisions out of HLD and preserves rationale.

## Purpose
Options, decision, rationale, consequences, revisit condition.
...
- **Primary artifact focus:** docs/03-architecture/ADR/adr-NNNN-*.md.
...
- **When using adp-arch-adr:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing docs/03-architecture/ADR/adr-NNNN-*.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `docs/03-architecture/ADR/adr-NNNN-*.md` is required.
...
## Outputs
- docs/03-architecture/ADR/adr-NNNN-*.md
