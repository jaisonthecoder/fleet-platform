...
Use this reference with `adp-ux-research` when the request needs more role-specific judgment than the workflow file contains.

## Scope

- **Owner role:** `ai-ux-ui-designer`
