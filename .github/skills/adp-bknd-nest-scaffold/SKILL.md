---
name: adp-bknd-nest-scaffold
description: "Monorepo (Nx/Turborepo) or single-app layout, modules, providers, common config split (database/openapi/logging), ESLint/Prettier, Jest/Supertest harness, CI baseline. Use when producing or updating \\\"backend Nest source, test project, repo configuration\\\". Owned by AI Backend Engineer (NestJS)."
---
...
- **why_critical:** Gives every backend slice the same structure and engineering baseline before feature code spreads.
- **default_prompt:** Use the adp-bknd-nest-scaffold skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Monorepo (Nx/Turborepo) or single-app layout, modules

**Owner role:** AI Backend Engineer (NestJS) (`ai-backend-nestjs`)
**Primary artifact:** backend Nest source, test project, repo configuration

## Why critical
Gives every backend slice the same structure and engineering baseline before feature code spreads.

## Purpose
Monorepo (Nx/Turborepo) or single-app layout, modules, providers, common config split (database/openapi/logging), ESLint/Prettier, Jest/Supertest harness, CI baseline.
...
- **Primary artifact focus:** backend Nest source, test project, repo configuration.
...
- **When using adp-bknd-nest-scaffold:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing backend Nest source, test project, repo configuration:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `backend Nest source, test project, repo configuration` is required.
...
## Outputs
- backend Nest source, test project, repo configuration
...
- `workflows/update-persistence.md`
...
- **Generated artifact:** `backend Nest source`, `test project`, `repo configuration`
