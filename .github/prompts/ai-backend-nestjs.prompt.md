---
agent: 'agent'
description: "Routes ai-backend-nestjs to the adp-bknd-nest-api task skill."
---
...
Use the `adp-bknd-nest-api` skill at `.github/skills/adp-bknd-nest-api/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-api/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.

Do not look for `.github/skills/ai-backend-nestjs` unless that exact folder exists.
