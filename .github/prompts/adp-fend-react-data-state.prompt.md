...
Use the `adp-fend-react-data-state` skill at `.github/skills/adp-fend-react-data-state/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-data-state/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
