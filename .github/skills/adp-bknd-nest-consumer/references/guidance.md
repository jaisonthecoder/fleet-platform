...
This adp-bknd-nest-consumer reference is intended for requests that need extra framework, api, integration guidance. Load it only when the current request depends on those details.
