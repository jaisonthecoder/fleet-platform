...
- Confirm the existing artifact plus the changed funding, benefit, approval, or source business case evidence.
...
2. Update only the affected investment rationale, funding, approval, benefit, risk, or evidence sections.
3. Preserve prior decision traceability and record what changed.
4. Tie every material update to source evidence such as a business case revision, budget note, portfolio record, or sponsor confirmation.
...
## Anti-patterns
- Rewriting the whole artifact for style when only the business case changed.
- Hiding changed funding or approval assumptions in narrative prose.
- Leaving stale benefit targets after the source business case changes.
