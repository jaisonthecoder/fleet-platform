...
Use the `adp-fend-react-component-patterns` skill at `.github/skills/adp-fend-react-component-patterns/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-component-patterns/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
