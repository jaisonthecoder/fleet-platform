---
name: adp-fend-react-data-state
description: "Data fetching, caching, state management conventions (opinion pack). Use when producing or updating \\\"convention pack loaded by feature/page/crosscut\\\". Owned by AI Frontend Engineer (React)."
---

# adp-fend-react-data-state
...
- **why_critical:** Encodes data-fetching, caching, and state-management conventions so AI does not invent a new pattern per feature.
- **default_prompt:** Use the adp-fend-react-data-state skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Data fetching, caching, state management conventions (opinion

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** convention pack loaded by feature/page/crosscut

## Why critical
Encodes data-fetching, caching, and state-management conventions so AI does not invent a new pattern per feature.

## Purpose
Data fetching, caching, state management conventions (opinion pack).
...
- **Primary artifact focus:** convention pack loaded by feature/page/crosscut.
...
- **When using adp-fend-react-data-state:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing convention pack loaded by feature/page/crosscut:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `convention pack loaded by feature/page/crosscut` is required.
...
## Outputs
- convention pack loaded by feature/page/crosscut
...
- **Generated artifact:** `convention pack loaded by feature/page/crosscut`
