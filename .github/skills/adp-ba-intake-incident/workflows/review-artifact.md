...
- Confirm the artifact under review plus incident source, impact, root cause status, corrective action, and validation expectation.
...
2. Check whether incident source, impact, root cause status, corrective action, validation expectation, and owner are complete.
3. Produce findings with severity, evidence, required follow-up, and downstream impact.
4. Identify unsupported operational claims, missing owners, weak validation expectations, and unclear decision gates.
5. State whether the artifact is ready for BRD, PRD, SRE, quality, support, or implementation handoff.
...
## Anti-patterns
- Approving an artifact whose incident source is not linked.
- Treating missing validation expectation as minor wording.
- Reviewing only format while ignoring operational evidence.
