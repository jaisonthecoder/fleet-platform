...
Use the `adp-fend-react-component` skill at `.github/skills/adp-fend-react-component/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-component/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
...
- `design-chart-data`
- `harden-feature`
- `implement-chartjs-chart`
- `implement-component`
- `optimize-chart-performance`
- `plan-chart-requirements`
- `produce-artifact`
- `review-artifact`
- `shadcn-extend-kit`
- `update-artifact`
