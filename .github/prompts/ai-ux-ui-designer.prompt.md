---
agent: 'agent'
description: "Routes ai-ux-ui-designer to the adp-ux-screens task skill."
---
...
Use the `adp-ux-screens` skill at `.github/skills/adp-ux-screens/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ux-screens/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.

Do not look for `.github/skills/ai-ux-ui-designer` unless that exact folder exists.
