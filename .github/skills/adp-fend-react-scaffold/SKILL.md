...
- **why_critical:** Gives frontend slices a stable project baseline and keeps global state setup out of feature-specific skills.
- **default_prompt:** Use the adp-fend-react-scaffold skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** App structure, build setup, lint, format, test harness, folder

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** frontend React source, test setup, repo configuration

## Why critical
Gives frontend slices a stable project baseline and keeps global state setup out of feature-specific skills.

## Purpose
App structure, build setup, lint, format, test harness, folder conventions, shared utilities, global store config.
...
- **Primary artifact focus:** frontend React source, test setup, repo configuration.
...
- **When using adp-fend-react-scaffold:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing frontend React source, test setup, repo configuration:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `frontend React source, test setup, repo configuration` is required.
...
## Outputs
- frontend React source, test setup, repo configuration
...
- `workflows/shadcn-after-you-finish.md`
- `workflows/shadcn-before-you-start.md`
- `workflows/shadcn-build-showcase.md`
- `workflows/shadcn-scaffold-kit.md`
- `workflows/test-frontend.md`
...
- `references/merged-from-shadcn-kit.md` — legacy `shadcn-kit` guidance merged into this ADP task skill.

## References

Load only the references needed for the current request:
- `references/after-you-finish.md` — supporting guidance.
- `references/apply-to-feature.md` — supporting guidance.
- `references/before-you-start.md` — supporting guidance.
- `references/build-showcase.md` — supporting guidance.
- `references/ci-pipeline.md` — supporting guidance.
- `references/extend-kit.md` — supporting guidance.
- `references/framework-adapters.md` — supporting guidance.
- `references/intent-routing.md` — supporting guidance.
- `references/scaffold-kit.md` — supporting guidance.
- `references/sections-catalog.md` — supporting guidance.
- `references/shadcn-framework-adapters.md` — supporting guidance.
- `references/shadcn-intent-routing.md` — supporting guidance.
- `references/shadcn-recipes.md` — supporting guidance.
- `references/shadcn-showcase-page.md` — supporting guidance.
- `references/shadcn-tailwind-mapping.md` — supporting guidance.
- `references/showcase-page.md` — supporting guidance.
- `references/tailwind-mapping.md` — supporting guidance.
- `references/testing.md` — categorised React test reference (unit, component, hook, integration, contract, E2E, accessibility) consumed by `workflows/test-frontend.md`.
- `references/tokens-spec.md` — supporting guidance.
- `references/workflows/after-you-finish.md` — supporting guidance.
- `references/workflows/apply-to-feature.md` — supporting guidance.
- `references/workflows/before-you-start.md` — supporting guidance.
- `references/workflows/build-showcase.md` — supporting guidance.
- `references/workflows/extend-kit.md` — supporting guidance.
- `references/workflows/scaffold-kit.md` — supporting guidance.
