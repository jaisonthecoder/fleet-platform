...
Use the `adp-bknd-nest-lld` skill at `.github/skills/adp-bknd-nest-lld/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-lld/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
