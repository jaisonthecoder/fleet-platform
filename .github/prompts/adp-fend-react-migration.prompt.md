...
Use the `adp-fend-react-migration` skill at `.github/skills/adp-fend-react-migration/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-migration/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
