...
Use the `adp-bknd-nest-agent` skill at `.github/skills/adp-bknd-nest-agent/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-agent/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
