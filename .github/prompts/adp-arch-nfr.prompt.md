...
Use the `adp-arch-nfr` skill at `.github/skills/adp-arch-nfr/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-arch-nfr/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
