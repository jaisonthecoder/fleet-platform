---
name: adp-arch-hld
description: "Context, application, conceptual, logical, integration flow, data, security, runtime, operations, technology views. Use when producing or updating \\\"hld.md, hld-*.drawio\\\". Owned by AI Solution Architect."
---
...
- **why_critical:** Gives AI and humans the architecture map before build, including the architecture-level integration flow before detailed integration specs.
- **default_prompt:** Use the adp-arch-hld skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Context, application, conceptual, logical, integration flow

**Owner role:** AI Solution Architect (`ai-solution-architect`)
**Primary artifact:** hld.md, hld-*.drawio

## Why critical
Gives AI and humans the architecture map before build, including the architecture-level integration flow before detailed integration specs.

## Purpose
Context, application, conceptual, logical, integration flow, data, security, runtime, operations, technology views.
...
- **Primary artifact focus:** hld.md, hld-*.drawio.
...
- **When using adp-arch-hld:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing hld.md, hld-*.drawio:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `hld.md, hld-*.drawio` is required.
...
- `templates/hld-template.md.tmpl` — High-Level Design.
...
- `references/merged-from-solution-architect.md` — legacy `solution-architect` guidance merged into this ADP task skill.
...
- **Generated artifact:** `hld.md`, `hld-*.drawio`
