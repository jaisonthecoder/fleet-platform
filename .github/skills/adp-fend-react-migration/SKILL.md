---
name: adp-fend-react-migration
description: "Cross-major React upgrade: version-by-version hop, deprecated APIs, concurrent/Suspense/RSC adoption, validation per step. Use when producing or updating \\\"migration-plan.md, migration-evidence.md, ADR\\\". Owned by AI Frontend Engineer (React)."
---

# adp-fend-react-migration
...
- **why_critical:** Cross-major React upgrades are version-by-version with breaking-change gates; encoding the sequence prevents big-bang upgrades and missed validation steps.
- **default_prompt:** Use the adp-fend-react-migration skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Cross-major React upgrade guidance

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** migration-plan.md, migration-evidence.md, ADR

## Why critical
Cross-major React upgrades are version-by-version with breaking-change gates; encoding the sequence prevents big-bang upgrades and missed validation steps.

## Purpose
Cross-major React upgrade: version-by-version hop, deprecated APIs, concurrent/Suspense/RSC adoption, validation per step.
...
- **Primary artifact focus:** migration-plan.md, migration-evidence.md, ADR.
...
- **When using adp-fend-react-migration:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing migration-plan.md, migration-evidence.md, ADR:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `migration-plan.md, migration-evidence.md, ADR` is required.
...
## Outputs
- migration-plan.md, migration-evidence.md, ADR
...
- `workflows/migrate-feature-slice.md`
- `workflows/migrate-state-and-data.md`
- `workflows/plan-cutover.md`
- `workflows/plan-migration-strategy.md`
- `workflows/validate-parity.md`

## Templates

Use these bundled templates when the request produces or updates the primary artifact:

- `templates/adr-template.md.tmpl` — Architecture Decision Record.
...
- `references/merged-from-angular-to-react-migration.md` — legacy `angular-to-react-migration` guidance merged into this ADP task skill.
...
- **Generated artifact:** `migration-plan.md`, `migration-evidence.md`, `ADR`
