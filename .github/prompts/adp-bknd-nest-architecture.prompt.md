...
Use the `adp-bknd-nest-architecture` skill at `.github/skills/adp-bknd-nest-architecture/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-architecture/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
