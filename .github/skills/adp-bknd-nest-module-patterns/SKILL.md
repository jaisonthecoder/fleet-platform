---
name: adp-bknd-nest-module-patterns
description: "Module/DI conventions: feature modules, dynamic modules, providers/scopes, global vs feature config, dependency boundaries (opinion pack). Use when producing or updating \\\"convention pack loaded by scaffold/api\\\". Owned by AI Backend Engineer (NestJS)."
---

# adp-bknd-nest-module-patterns
...
- **why_critical:** Module boundaries and provider scopes are the dominant failure mode in NestJS; encoding the conventions prevents global-vs-feature scope mistakes and dynamic-module sprawl.
- **default_prompt:** Use the adp-bknd-nest-module-patterns skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Module/DI conventions guidance

**Owner role:** AI Backend Engineer (NestJS) (`ai-backend-nestjs`)
**Primary artifact:** convention pack loaded by scaffold/api

## Why critical
Module boundaries and provider scopes are the dominant failure mode in NestJS; encoding the conventions prevents global-vs-feature scope mistakes and dynamic-module sprawl.

## Purpose
Module/DI conventions: feature modules, dynamic modules, providers/scopes, global vs feature config, dependency boundaries (opinion pack).
...
- **Primary artifact focus:** convention pack loaded by scaffold/api.
...
- **When using adp-bknd-nest-module-patterns:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing convention pack loaded by scaffold/api:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `convention pack loaded by scaffold/api` is required.
...
## Outputs
- convention pack loaded by scaffold/api
...
- **Generated artifact:** `convention pack loaded by scaffold/api`
