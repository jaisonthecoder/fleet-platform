---
name: adp-review-pr
description: "Code/PR review: convention adherence, security, test coverage delta, performance smells, edges, blast radius. Use when producing or updating \\\"PR comments, decision in review-record.md\\\". Owned by AI Reviewer."
---
...
- **why_critical:** Catches code-level defects, drift from standards, and risky changes before they reach release.
- **default_prompt:** Use the adp-review-pr skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Code/PR review: convention adherence, security, test coverage

**Owner role:** AI Reviewer (`ai-reviewer`)
**Primary artifact:** PR comments, decision in review-record.md

## Why critical
Catches code-level defects, drift from standards, and risky changes before they reach release.

## Purpose
Code/PR review: convention adherence, security, test coverage delta, performance smells, edges, blast radius.
...
- **Primary artifact focus:** PR comments, decision in review-record.md.
...
- **When using adp-review-pr:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing PR comments, decision in review-record.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `PR comments, decision in review-record.md` is required.
...
## Outputs
- PR comments, decision in review-record.md
...
- `references/merged-from-code-reviewer.md` — legacy `code-reviewer` guidance merged into this ADP task skill.
...
- **Generated artifact:** `PR comments`, `decision in review-record.md`
