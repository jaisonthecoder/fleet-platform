...
Complete the requested convention pack loaded by scaffold work so `ai-quality-engineer`, `ai-reviewer`, `ai-ux-ui-designer` can proceed with traceable evidence and explicit AD Ports assumptions.
...
- The artifact is stored at the standard path for adp-fend-react-vite-architecture.
