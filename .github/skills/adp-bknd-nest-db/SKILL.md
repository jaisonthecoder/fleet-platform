...
- **why_critical:** Keeps domain/data design, migrations, runtime impact, and implementation in sync.
- **default_prompt:** Use the adp-bknd-nest-db skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Schema, migrations (TypeORM/Prisma/MikroORM), indexes

**Owner role:** AI Backend Engineer (NestJS) (`ai-backend-nestjs`)
**Primary artifact:** migrations, backend Nest source, lld-data-spec-data-model.md, devops-change-set.md

## Why critical
Keeps domain/data design, migrations, runtime impact, and implementation in sync.

## Purpose
Schema, migrations (TypeORM/Prisma/MikroORM), indexes, repository pattern, query shape, data access code, tests.
...
- **Primary artifact focus:** migrations, backend Nest source, lld-data-spec-data-model.md, devops-change-set.md.
...
- **When using adp-bknd-nest-db:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing migrations, backend Nest source, lld-data-spec-data-model.md, devops-change-set.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `migrations, backend Nest source, lld-data-spec-data-model.md, devops-change-set.md` is required.
...
## Outputs
- migrations, backend Nest source, lld-data-spec-data-model.md, devops-change-set.md
...
- **Generated artifact:** `migrations`, `backend Nest source`, `lld-data-spec-data-model.md`, `devops-change-set.md`
