...
Use the `adp-ba-strategy-analysis` skill at `.github/skills/adp-ba-strategy-analysis/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ba-strategy-analysis/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
