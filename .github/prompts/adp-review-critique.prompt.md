...
Use the `adp-review-critique` skill at `.github/skills/adp-review-critique/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-review-critique/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
