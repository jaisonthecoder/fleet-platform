---
name: adp-ux-research
description: "UX research summary, personas, journey maps/service blueprints, information architecture, user flows, navigation, content model. Use when producing or updating \\\"ux-research.md\\\". Owned by AI UX/UI Designer."
---
...
- **why_critical:** Gives product, design, and frontend a single UX structure before screens and implementation detail are created.
- **default_prompt:** Use the adp-ux-research skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** UX research, personas, journeys, IA, user flows

**Owner role:** AI UX/UI Designer (`ai-ux-ui-designer`)
**Primary artifact:** ux-research.md

## Why critical
Gives product, design, and frontend a single UX structure before screens and implementation detail are created.

## Purpose
UX research summary, personas, journey maps/service blueprints, information architecture, user flows, navigation, content model.
...
- **Primary artifact focus:** ux-research.md.
...
- **When using adp-ux-research:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing ux-research.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `ux-research.md`, personas, journey maps, service blueprints, or user flows is required.
...
## Outputs
- ux-research.md with research findings, personas, journey maps/service blueprints, IA, user flows, navigation, and content model.
- User journey diagram embedded in or linked from `ux-research.md` when the artifact includes a journey map, service blueprint, or user flow; prefer Mermaid for repo-native Markdown review and use parser-safe labels.
...
- `templates/artifact-template.md.tmpl` — Artifact.
...
- **Generated artifact:** `ux-research.md`
...
- Mermaid journey and flow diagrams use parser-safe labels: no semicolons, no raw pipes, balanced brackets/quotes, and quoted labels when punctuation is needed.
