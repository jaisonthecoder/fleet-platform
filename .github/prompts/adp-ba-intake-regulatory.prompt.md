...
Use the `adp-ba-intake-regulatory` skill at `.github/skills/adp-ba-intake-regulatory/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ba-intake-regulatory/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
