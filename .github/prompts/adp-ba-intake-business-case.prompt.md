...
Use the `adp-ba-intake-business-case` skill at `.github/skills/adp-ba-intake-business-case/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ba-intake-business-case/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
