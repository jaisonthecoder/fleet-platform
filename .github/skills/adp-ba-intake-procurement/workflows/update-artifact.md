...
- Confirm the existing artifact plus the changed procurement, commercial, vendor, security, impact, or owner evidence.
...
2. Update only the affected procurement need, commercial context, vendor role, security impact, risk, or owner sections.
3. Preserve prior decision traceability and record what changed.
4. Tie every material update to source evidence such as a procurement update, contract revision, sourcing note, vendor material, or owner confirmation.
...
## Anti-patterns
- Rewriting the whole artifact for style when only the vendor record changed.
- Leaving stale security or commercial impacts after procurement changes.
- Updating scope without routing procurement, legal, security, or architecture uncertainty.
