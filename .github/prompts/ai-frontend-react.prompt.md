---
agent: 'agent'
description: "Routes ai-frontend-react to the adp-fend-react-page task skill."
---
...
Do not look for `.github/skills/ai-frontend-react` unless that exact folder exists.
