...
Use the `adp-fend-react-vite-architecture` skill at `.github/skills/adp-fend-react-vite-architecture/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-vite-architecture/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
