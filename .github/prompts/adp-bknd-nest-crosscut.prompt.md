...
Use the `adp-bknd-nest-crosscut` skill at `.github/skills/adp-bknd-nest-crosscut/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-crosscut/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
