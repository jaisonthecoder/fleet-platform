...
Use the `adp-bknd-nest-consumer` skill at `.github/skills/adp-bknd-nest-consumer/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-consumer/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
