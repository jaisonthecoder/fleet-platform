---
name: adp-fend-react-lld
description: "Routes, page composition, component/feature boundaries, data flow, validation, loading/error behavior, test approach. Use when producing or updating \\\"frontend LLD section in lld.md, diagrams/lld-frontend-*.drawio\\\". Owned by AI Frontend Engineer (React)."
---
...
- **default_prompt:** Use the adp-fend-react-lld skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Routes, page composition, component/feature boundaries, data
...
## Purpose
Routes, page composition, component/feature boundaries, data flow, validation, loading/error behavior, test approach.
...
- **Primary artifact focus:** frontend LLD section in lld.md, diagrams/lld-frontend-*.drawio.
...
- **When using adp-fend-react-lld:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing frontend LLD section in lld.md, diagrams/lld-frontend-*.drawio:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `frontend LLD section in lld.md, diagrams/lld-frontend-*.drawio` is required.
...
## Outputs
- frontend LLD section in lld.md, diagrams/lld-frontend-*.drawio
...
- **Required inputs:** `prd.md`, `hld.md`, `UX design`, `accessibility constraints`
- **Generated artifact:** `frontend LLD section in lld.md`, `diagrams/lld-frontend-*.drawio`
