...
Use the `adp-bknd-nest-tests` skill at `.github/skills/adp-bknd-nest-tests/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-tests/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
