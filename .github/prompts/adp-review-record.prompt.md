...
Use the `adp-review-record` skill at `.github/skills/adp-review-record/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-review-record/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.

## Available Workflows

- `arbitrate-technical-decision`
- `assess-change-risk`
- `coach-engineer`
- `produce-artifact`
- `review-artifact`
