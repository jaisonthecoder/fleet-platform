---
name: adp-fend-react-component-patterns
description: "Component authoring conventions: composition, props, a11y patterns (opinion pack). Use when producing or updating \\\"convention pack loaded by component/page\\\". Owned by AI Frontend Engineer (React)."
---

# adp-fend-react-component-patterns
...
- **why_critical:** Encodes component-authoring conventions (composition, props, a11y) so AI-generated components do not drift in style or behavior.
- **default_prompt:** Use the adp-fend-react-component-patterns skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Component authoring conventions guidance

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** convention pack loaded by component/page

## Why critical
Encodes component-authoring conventions (composition, props, a11y) so AI-generated components do not drift in style or behavior.

## Purpose
Component authoring conventions: composition, props, a11y patterns (opinion pack).
...
- **Primary artifact focus:** convention pack loaded by component/page.
...
- **When using adp-fend-react-component-patterns:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing convention pack loaded by component/page:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `convention pack loaded by component/page` is required.
...
## Outputs
- convention pack loaded by component/page
...
- **Generated artifact:** `convention pack loaded by component/page`
