...
Use the `adp-ux-design-kit` skill at `.github/skills/adp-ux-design-kit/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ux-design-kit/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
