...
Use the `adp-ba-intake-demand` skill at `.github/skills/adp-ba-intake-demand/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ba-intake-demand/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
