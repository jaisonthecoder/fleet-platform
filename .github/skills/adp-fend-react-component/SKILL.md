---
name: adp-fend-react-component
description: "Reusable UI primitive: props, events, local behavior, states, a11y, styling contract, examples, tests. Use when producing or updating \\\"frontend React source code\\\". Owned by AI Frontend Engineer (React)."
---

# adp-fend-react-component
...
- **why_critical:** Keeps reusable UI behavior predictable and prevents component drift across pages.
- **default_prompt:** Use the adp-fend-react-component skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Reusable UI primitive guidance

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** frontend React source code

## Why critical
Keeps reusable UI behavior predictable and prevents component drift across pages.

## Purpose
Reusable UI primitive: props, events, local behavior, states, a11y, styling contract, examples, tests.
...
- **Primary artifact focus:** frontend React source code.
...
- **When using adp-fend-react-component:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing frontend React source code:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `frontend React source code` is required.
...
- `workflows/design-chart-data.md`
- `workflows/implement-chartjs-chart.md`
- `workflows/implement-component.md`
- `workflows/optimize-chart-performance.md`
- `workflows/plan-chart-requirements.md`
- `workflows/shadcn-extend-kit.md`
- `workflows/validate-chart-quality.md`
...
- `references/accessibility-i18n.md` — supporting guidance.
- `references/anti-patterns.md` — supporting guidance.
- `references/chartjs-patterns.md` — supporting guidance.
...
- `templates/react-component.tsx.tmpl` — React Component Skeleton.
...
- **Generated artifact:** `frontend React source code`
