---
agent: 'agent'
description: "Routes ai-governance-lead to the adp-gov-wiki-docs task skill."
---
...
Use the `adp-gov-wiki-docs` skill at `.github/skills/adp-gov-wiki-docs/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-gov-wiki-docs/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.

Do not look for `.github/skills/ai-governance-lead` unless that exact folder exists.
