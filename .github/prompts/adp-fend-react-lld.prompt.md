...
Use the `adp-fend-react-lld` skill at `.github/skills/adp-fend-react-lld/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-lld/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
