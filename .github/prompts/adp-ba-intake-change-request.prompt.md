...
Use the `adp-ba-intake-change-request` skill at `.github/skills/adp-ba-intake-change-request/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ba-intake-change-request/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
