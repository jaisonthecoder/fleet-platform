---
name: adp-bknd-nest-consumer
description: "Reactive slice: queue/event consumer (BullMQ, Kafka, RabbitMQ, SQS), webhook receiver, retries, idempotency, DLQ handling, tests. Use when producing or updating \\\"backend Nest source, backend tests, lld-integration-spec.md\\\". Owned by AI Backend Engineer (NestJS)."
---
...
- **why_critical:** Prevents asynchronous behavior from becoming hidden, fragile, or untestable.
- **default_prompt:** Use the adp-bknd-nest-consumer skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Reactive slice: queue/event consumer , webhook receiver

**Owner role:** AI Backend Engineer (NestJS) (`ai-backend-nestjs`)
**Primary artifact:** backend Nest source, backend tests, lld-integration-spec.md

## Why critical
Prevents asynchronous behavior from becoming hidden, fragile, or untestable.

## Purpose
Reactive slice: queue/event consumer (BullMQ, Kafka, RabbitMQ, SQS), webhook receiver, retries, idempotency, DLQ handling, tests.
...
- **Primary artifact focus:** backend Nest source, backend tests, lld-integration-spec.md.
...
- **When using adp-bknd-nest-consumer:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing backend Nest source, backend tests, lld-integration-spec.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `backend Nest source, backend tests, lld-integration-spec.md` is required.
...
## Outputs
- backend Nest source, backend tests, lld-integration-spec.md
...
- **Generated artifact:** `backend Nest source`, `backend tests`, `lld-integration-spec.md`
