...
Use the `adp-ba-intake-procurement` skill at `.github/skills/adp-ba-intake-procurement/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ba-intake-procurement/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
