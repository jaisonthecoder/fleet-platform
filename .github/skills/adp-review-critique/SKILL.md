---
name: adp-review-critique
description: "Non-code artifact review: PRDs, UX/UI designs, LLDs, release plans, docs, and design critique reports. Use when producing or updating \\\"artifact review findings/comments\\\". Owned by AI Reviewer."
---
...
- **why_critical:** Catches reasoning and design gaps before downstream roles build on weak context.
- **default_prompt:** Use the adp-review-critique skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Non-code and UX artifact review guidance

**Owner role:** AI Reviewer (`ai-reviewer`)
**Primary artifact:** artifact review findings/comments

## Why critical
Catches reasoning and design gaps before downstream roles build on weak context.

## Purpose
Non-code artifact review: PRDs, UX/UI designs, LLDs, release plans, docs, and design critique reports.

## Abu Dhabi Ports Group context

Apply this skill as AI Reviewer delivery guidance for AD Ports work. The role-specific AD Ports edges are risk-first findings, tenant isolation, security and data-residency regressions, missing evidence, standards drift, and clear merge readiness. Keep outputs traceable to source evidence, tenant-aware, UAE-regulatory aware, operationally resilient, and ready for audit handoff.

## Mental model

- **Protects:** downstream delivery readiness.
- **Optimizes for:** risk-first artifact findings with precise remediation and owners.
- **Refuses to leave ambiguous:** artifact intent, user impact, evidence, security, accessibility, or handoff ambiguity.
- **Primary artifact focus:** artifact review findings/comments.
...
- **When using adp-review-critique:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing artifact review findings/comments:** confirm the artifact is owned by this skill and not a neighboring role.
- **Before changing scope:** confirm the change still protects downstream delivery readiness and does not dilute risk-first findings with precise remediation.
...
- A reviewer should be able to see how this skill handled artifact intent, user impact, evidence, security, accessibility, or handoff ambiguity.
...
- A new instance of `artifact review findings/comments` is required.
...
## Outputs
- artifact review findings/comments
...
- `workflows/review-ux-critique.md`
...
- `references/ux-critique.md` — UX critique scoring, detector fallback, persona walkthrough, and evidence package.
...
- **SDLC stage:** Review
- **Ordered by:** `ai-product-manager`, `ai-business-analyst`, `ai-solution-architect`, `ai-ux-ui-designer`, `ai-frontend-react`, `ai-frontend-angular`, `ai-mobile-rn`, `ai-mobile-ios`, `ai-mobile-android`, `ai-mobile-flutter`, `ai-platform-engineer`, `ai-quality-engineer`, `ai-security-engineer`
- **Required inputs:** `artifact under review`, `source request or ticket`, `acceptance criteria or design goal`, `applicable standards`, `known risk summary`
- **Generated artifact:** `artifact review findings/comments`, `UX critique report when reviewing UI`
- **Next roles:** `owning artifact role`, `ai-quality-engineer`, `ai-delivery-planner`, `ai-frontend-react`, `ai-frontend-angular`, `ai-mobile-rn`
- **Human gate:** `artifact approval`, `UX sign-off`, `accessibility exception`, `risk acceptance`

## Handoff

- **Upstream:** Confirm the request, source evidence, and approved upstream artifacts before acting.
- **Downstream:** owning artifact role, `ai-delivery-planner`, `ai-quality-engineer`, and relevant frontend/mobile role when UI findings require implementation.
...
- **Primary owner:** `ai-reviewer` (AI Reviewer)
