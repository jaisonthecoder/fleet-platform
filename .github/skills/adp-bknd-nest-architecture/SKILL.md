---
name: adp-bknd-nest-architecture
description: "Backend architecture and LLD: module boundaries, sequence, OpenAPI, class-validator DTOs, errors, implementation notes. Use when producing or updating \\\"lld.md, lld-api-spec.md, lld-data-spec-data-model.md\\\". Owned by AI Backend Engineer (NestJS)."
---

# adp-bknd-nest-architecture
...
- **why_critical:** Prevents backend implementation from inventing design details after architecture approval.
- **default_prompt:** Use the adp-bknd-nest-architecture skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Stack architecture and LLD guidance

**Owner role:** AI Backend Engineer (NestJS) (`ai-backend-nestjs`)
**Primary artifact:** architecture guidance, LLD sections, lld.md, lld-api-spec.md, lld-data-spec-data-model.md

## Why critical
Prevents backend implementation from inventing design details after architecture approval.

## Purpose
Backend architecture and LLD design: module boundaries, sequence, OpenAPI, class-validator DTOs, errors, implementation notes.
...
- **Primary artifact focus:** architecture guidance, LLD sections, lld.md, lld-api-spec.md, lld-data-spec-data-model.md.
...
- **When using adp-bknd-nest-architecture:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing architecture guidance, LLD sections, lld.md, lld-api-spec.md, lld-data-spec-data-model.md:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `architecture guidance, LLD sections, lld.md, lld-api-spec.md, lld-data-spec-data-model.md` is required.
...
## Outputs
- lld.md, lld-api-spec.md, lld-data-spec-data-model.md
...
- `references/build-backend.md` — supporting guidance.
- `references/define-api.md` — supporting guidance.
- `references/design-backend.md` — supporting guidance.
...
- `references/nestjs-anti-patterns.md` — supporting guidance.
- `references/security-baseline.md` — supporting guidance.
- `references/test-backend.md` — supporting guidance.
- `references/testing-patterns.md` — supporting guidance.
- `references/update-persistence.md` — supporting guidance.
- `references/workflows/build-backend.md` — supporting guidance.
- `references/workflows/define-api.md` — supporting guidance.
- `references/workflows/test-backend.md` — supporting guidance.
- `references/workflows/update-persistence.md` — supporting guidance.
...
- `references/merged-from-backend-nestjs.md` — legacy `backend-nestjs` guidance merged into this ADP task skill.
...
- **SDLC stage:** Backend design
- **Ordered by:** `ai-solution-architect`
- **Required inputs:** `prd.md`, `hld.md`, `nfrs`, `API/data/integration context`
- **Generated artifact:** `architecture guidance`, `LLD sections`, `lld.md`, `lld-api-spec.md`, `lld-data-spec-data-model.md`
