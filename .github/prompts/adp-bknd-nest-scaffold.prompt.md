...
Use the `adp-bknd-nest-scaffold` skill at `.github/skills/adp-bknd-nest-scaffold/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-scaffold/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
