...
Use the `adp-fend-react-tests` skill at `.github/skills/adp-fend-react-tests/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-tests/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
