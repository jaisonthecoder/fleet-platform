...
Complete the requested convention pack loaded by scaffold/api work so `ai-quality-engineer`, `ai-reviewer`, `ai-sre` can proceed with traceable evidence and explicit AD Ports assumptions.
...
- The artifact is stored at the standard path for adp-bknd-nest-module-patterns.
