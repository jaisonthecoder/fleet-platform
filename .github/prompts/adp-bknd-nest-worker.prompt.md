...
Use the `adp-bknd-nest-worker` skill at `.github/skills/adp-bknd-nest-worker/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-bknd-nest-worker/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
