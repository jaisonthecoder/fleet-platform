...
This adp-bknd-nest-scaffold reference is intended for requests that need extra framework, api, schema-data guidance. Load it only when the current request depends on those details.
