---
name: adp-bknd-nest-agent
description: "AI-native backend agent loop: planning/execution loop, tools, memory/state, guardrails, eval hooks, telemetry, tests (Anthropic SDK / LangGraph.js). Use when producing or updating \\\"backend Nest source, backend tests\\\". Owned by AI Backend Engineer (NestJS)."
---
...
- **why_critical:** Keeps AI-native runtime behavior governed as an application slice, not an unstructured prompt experiment.
- **default_prompt:** Use the adp-bknd-nest-agent skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** AI-native backend agent loop guidance

**Owner role:** AI Backend Engineer (NestJS) (`ai-backend-nestjs`)
**Primary artifact:** backend Nest source, backend tests

## Why critical
Keeps AI-native runtime behavior governed as an application slice, not an unstructured prompt experiment.

## Purpose
AI-native backend agent loop: planning/execution loop, tools, memory/state, guardrails, eval hooks, telemetry, tests (Anthropic SDK / LangGraph.js).
...
- **Primary artifact focus:** backend Nest source, backend tests.
...
- **When using adp-bknd-nest-agent:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing backend Nest source, backend tests:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `backend Nest source, backend tests` is required.
...
## Outputs
- backend Nest source, backend tests
...
- **Generated artifact:** `backend Nest source`, `backend tests`
