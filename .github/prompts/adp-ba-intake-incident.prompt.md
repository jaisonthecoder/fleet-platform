...
Use the `adp-ba-intake-incident` skill at `.github/skills/adp-ba-intake-incident/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-ba-intake-incident/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
