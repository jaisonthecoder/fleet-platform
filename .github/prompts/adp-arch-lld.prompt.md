...
Use the `adp-arch-lld` skill at `.github/skills/adp-arch-lld/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-arch-lld/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
