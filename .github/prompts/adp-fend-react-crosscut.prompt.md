...
Use the `adp-fend-react-crosscut` skill at `.github/skills/adp-fend-react-crosscut/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-fend-react-crosscut/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
