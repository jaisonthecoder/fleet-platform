---
name: adp-fend-react-vite-architecture
description: "Vite project conventions, build, module boundaries (opinion pack). Use when producing or updating \\\"convention pack loaded by scaffold\\\". Owned by AI Frontend Engineer (React)."
---

# adp-fend-react-vite-architecture
...
- **why_critical:** Encodes the project's Vite + module-boundary opinions so every scaffolded React app follows the same shape.
- **default_prompt:** Use the adp-fend-react-vite-architecture skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Vite project conventions, build, module boundaries (opinion

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** convention pack loaded by scaffold

## Why critical
Encodes the project's Vite + module-boundary opinions so every scaffolded React app follows the same shape.

## Purpose
Vite project conventions, build, module boundaries (opinion pack).
...
- **Primary artifact focus:** convention pack loaded by scaffold.
...
- **When using adp-fend-react-vite-architecture:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing convention pack loaded by scaffold:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `convention pack loaded by scaffold` is required.
...
## Outputs
- convention pack loaded by scaffold
...
- **Generated artifact:** `convention pack loaded by scaffold`
