...
Use the `adp-pm-fr` skill at `.github/skills/adp-pm-fr/SKILL.md`.

Open the skill, pick the matching workflow under `.github/skills/adp-pm-fr/workflows/`, and complete the request with evidence. Resolve any referenced templates or references relative to that folder.
