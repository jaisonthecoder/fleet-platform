---
name: adp-fend-react-page
description: "Route slice end-to-end: page, route loader/action, form/table/view state, API calls, validation, a11y, loading/error, tests. Use when producing or updating \\\"frontend React source, frontend tests\\\". Owned by AI Frontend Engineer (React)."
---
...
- **why_critical:** Produces a complete routed user-facing path instead of isolated UI fragments.
- **default_prompt:** Use the adp-fend-react-page skill. Open SKILL.md, choose the matching workflow, and complete the request with evidence.
- **short_description:** Route slice end-to-end guidance

**Owner role:** AI Frontend Engineer (React) (`ai-frontend-react`)
**Primary artifact:** frontend React source, frontend tests

## Why critical
Produces a complete routed user-facing path instead of isolated UI fragments.

## Purpose
Route slice end-to-end: page, route loader/action, form/table/view state, API calls, validation, a11y, loading/error, tests.
...
- **Primary artifact focus:** frontend React source, frontend tests.
...
- **When using adp-fend-react-page:** finish with the files changed and the evidence a reviewer should inspect first.

## Decision checkpoints

- **Before producing frontend React source, frontend tests:** confirm the artifact is owned by this skill and not a neighboring role.
...
- A new instance of `frontend React source, frontend tests` is required.
...
## Outputs
- frontend React source, frontend tests
...
- **Generated artifact:** `frontend React source`, `frontend tests`
